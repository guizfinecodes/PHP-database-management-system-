...
<div class="wrapper row1">
  <header id="header" class="clear"> 
    ...
    <div id="logo" class="fl_left">
      <h1><a href="professional.php <?php echo '?id='.$id; ?>">PROFESSIONALS' DB FORUM</a></h1>
    </div>
    <!-- ################################################################################################ -->
    <nav id="mainav" class="fl_right">
      <ul class="clear">
        <!--<li ><a href="index.php">Home</a></li>-->
        <li class="active"><a  href="professional.php <?php echo '?id='.$id; ?>">Account</a>
          <!--<ul>
...
&nbsp;
                                  <span class="green">upate you profile<br> please if you <br>cant find your<br>picture.</span>
                                </a>
                              </li>
                      ...
                      <div class="profile-contact-info">
                        <div class="profile-contact-links align-left">
                          <a href="update_profile.php <?php echo '?id='.$id; ?>" class="btn btn-link">
                            <i class="ace-icon fa fa-plus-circle bigger-120 green"></i>
                            UPDATE PROFILE
                          </a>

                          <a href="view_profile.php <?php echo '?id='.$id; ?>" class="btn btn-link">
                      ...
                      <div class="profile-user-info profile-user-info-striped">
                        ...
                        <div class="profile-info-row">
                          ...
                          <div class="profile-info-value">
                            ...
                            <span class="editable" id="country"><?php echo $county; ?></span>
                        ...
                        <div class="profile-info-row">
                          ...
                          <div class="profile-info-value">
                            <span  class="editable" id="age"><?php echo $age; ?></span>
                          </div>
                        </div>
                        ...
                        <div class="profile-info-row">
                          ...
                          <div class="profile-info-value">
                            <span class="editable" id="about"><?php echo $phone; ?></span>
                          </div>
                        </div>
                        ...
                        <div class="profile-info-row">
                          ...
                          <div class="profile-info-value">
                            <span class="editable" id="signup"><?php echo $email; ?></span>
                          </div>
                        </div>
                        ...
                        <div class="profile-info-row">
                          ...
                          <div class="profile-info-value">
                            <span class="editable" id="about"><?php echo $education; ?></span>
                          </div>
                        </div>
                        ...
                        <div class="profile-info-row">
                          ...
                          <div class="profile-info-value">
                            <span class="editable" id="login"><?php echo $profession; ?></span>
                          </div>
                        </div>
                        ...
                        <div class="profile-info-row">
                          ...
                          <div class="profile-info-value">
                            <span class="editable" id="about"><?php echo $gender; ?></span>
                          </div>
                        </div>
                        ...
                        <div class="profile-info-row">
                          ...
                          <div class="profile-info-value">
                            <span class="editable" id="about"><?php echo $website; ?></span>
                          </div>
                        </div>

                        <div class="profile-info-row">
                          <div class="profile-info-name">More about you</div>

                          <div class="profile-info-value">
                            <span class="editable" id="about"><?php echo $textarea; ?></span>
                          </div>
                        </div>
            ...
            image: {
              ...
              on_error : function(error_type) {//on_error function will be called when the selected file has a problem
                ...
                if(error_type == 1) {//file format error
                  ...
                  last_gritter = $.gritter.add({
                    title: 'File too big!',
                    text: 'Image size should not exceed 400Kb!',
                    class_name: 'gritter-error gritter-center'
                  });
                }
                else {//other error
              ...
              setTimeout(function(){
                ...
                last_gritter = $.gritter.add({
                  ...
                  text: 'You are welcome, please, take your time.',
