...
<html>
<head>
<title>P-FORUM | notification</title>
<meta charset="utf-8">
...
<div class="row">
							<div class="col-xs-12">
										...
										<div class="tabbable">
											<ul id="inbox-tabs" class="inbox-tabs nav nav-tabs padding-16 tab-size-bigger tab-space-1">
												<li class="li-new-mail pull-right">
													...
													<a href="professional.php <?php echo '?id='.$id; ?>" class="btn btn-success"><i class="glyphicon glyphicon-info" name="view_profile"></i>Back</a>
												</li><!-- /.li-new-mail -->
                                ...
                                echo "you have $num_rows inbox messages"; 
                               ...
                               $sql ="SELECT  * from notification where user_id='$id'";
                                ...
                                $id = $row['notification_id'];
                                 ...
                                 ?>
                                                ...
                                                <td><center><i class="message-star ace-icon fa fa-star-o orange2"></i><span class="sender" title="subject"><?php echo $row['subject']; ?></span></center></td>
                                               <!--check id and target-->
                                                <td><i class="ace-icon fa fa-mail-forward light-grey"></i><a target="" href="read_message.php<?php echo '?id='.$id; ?>"><?php echo $row['notification']; ?></td>
                                                <td><center><?php echo $row['sentdate']." ".$row['senttime']; ?></center></td>
</tr>
                                                ...
                                                <?php } ?>
														...
														<div class="message-footer clearfix">
															<div class="pull-left"> <?php echo $num_rows ?> messages total </div>
