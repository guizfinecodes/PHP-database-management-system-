...
<?php
 if (isset($_POST['delete'])){
                                            ...
                                            $sql2=" UPDATE `users` SET `active`='2' WHERE `user_id`='$id'"; 
                            ...
                            <?php
                                                    ...
                                                    <script>
                                                    alert('Account Succsessfully deleted');
...
<html>
<head>
<title>P-FORUM | delete account</title>
<meta charset="utf-8">
      ...
      <ul class="clear">
        ...
        <li ><a  href="view_profile.php <?php echo '?id='.$id; ?>">view profile</a>
          <!--<ul>-->
            ...
            <li class="active"><a  href="delete_account.php <?php echo '?id='.$id; ?>">delete account</a>
              <!--<ul>
...
<form class="form-horizontal" action="delete_account.php" method="post" enctype="multipart/form-data">
                              ...
                              <div class="form-group">
                                <label class=" control-label no-padding-right" for="form-field-comment"><font color="green"><u><h2>Confirm delete account</h2></u></font></label>
                              ...
                              <label>user ID:</label>
                                ...
                                <input type="text" name="name" id="name" readonly value="<?php echo $firstname?> <?php echo $lastname?>" class="form-control">
                                <hr>

                                <button type="submit" name="delete" id="upload" value="Save Record" class="btn btn-danger btn-labeled">delete Account<span class="btn-label btn-label-right"><i class="fa fa-trash"></i></span></button>
