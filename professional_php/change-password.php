      ...
      <ul class="clear">
        ...
        <li><a  href="view_profile.php <?php echo '?id='.$id; ?>">view profile</a>
          <!--<ul>-->
            ...
            <li class="active"><a  href="change-password.php <?php echo '?id='.$id; ?>">change password</a>
              <!--<ul>
...
<div class="wrapper row5">
  <div id="copyright" class="clear"> 
    <!-- ################################################################################################ -->
    <p style="text-align: center;">Copyright &copy; guizfinecodes 2019 - All Rights Reserved - <a href="#"><font color="sky blue">guizfinecodes</font></a></p>
