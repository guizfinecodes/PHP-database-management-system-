  ...
  <div id="topbar" class="clear">
    ...
    <div class="fl_right">
      <ul class="nospace inline">
        ...
        <li><i class="fa fa-envelope-o"></i>guiz.finecoes@gmail.com</li>
      </ul>
    </div>
    <!-- ################################################################################################ -->
  </div>
  ...
  <header id="header" class="clear"> 
    ...
    <nav id="mainav" class="fl_right">
      <ul class="clear">
        ...
        <li class="active"><a  href="employer_update_profile.php <?php echo '?id='.$id; ?>"> profile update</a>
          <!--<ul>-->
            <li><a href="view_clients.php <?php echo '?id='.$id; ?>">view clients</a></li>
            <li><a  href="employer_change_password.php <?php echo '?id='.$id; ?>">Change password</a>
              <!--<ul>
...
<div>
		...
		&nbsp; -->
											...
											<form class="form-horizontal" action="update_profile2.php" method="post" enctype="multipart/form-data">
												<div class="tabbable">
                                ...
                                <input type="text" name="user_id" id="user_id" readonly value="<?php echo $id?>" class="form-control">
																...
																<div class="col-xs-12 col-sm-4">
																	...
																	<div class="form-group">
																		<label class="col-sm-4 control-label no-padding-right" for="form-field-username">User firstname</label>
																	...
																	<div class="form-group">
																		<label class="col-sm-4 control-label no-padding-right" for="form-field-username">User lastname</label>
																	...
																	<div class="form-group">
																		<label class="col-sm-4 control-label no-padding-right" for="form-field-username">User Username</label>
															...
															<div class="form-group">
																...
																<div class="col-sm-9">
																	<span class="input-icon input-icon-right">
																		<input type="email" id="form-field-email" required="" name="company_email" value="<?php echo $company_email ?>" />
															...
															<div class="form-group">
																...
																<div class="col-sm-9">
																	<span class="input-icon input-icon-right">
																		<input type="url" id="form-field-website" value="<?php echo $company_website ?>" name="company_website" placeholder="http://www.1234.com/" />
															...
															<div class="form-group">
																...
																<div class="col-sm-9">
																	<span class="input-icon input-icon-right">
																		<input  name="company_phone" required="" type="text" id="form-field-phone" value="<?php echo $company_phone ?>" />
																...
																<div class="col-xs-12 col-sm-8">
																	<h4 class="header blue bolder smaller">Information</h4>

																	<div class="form-group">
																		<label class="col-sm-4 control-label no-padding-right" for="form-field-username">Company Name</label>

																		<div class="col-sm-8">
																			<input class="col-xs-12 col-sm-10" type="text" required="" id="form-field-username" placeholder="ministry of education" name="company_name" value="<?php echo $company_name ?>" >
																		</div>
																	</div>

																	<div class="form-group">
																		<label class="col-sm-4 control-label no-padding-right" for="form-field-username">Company Location</label>

																		<div class="col-sm-8">
																			<input class="col-xs-12 col-sm-10" type="text" required="" id="form-field-username" placeholder="Nairobi- industrial Area" name="location" value="<?php echo $location ?>" >
																		</div>
																	</div>
																	<div class="form-group">
																		<label class="col-sm-4 control-label no-padding-right" for="form-field-username">Company Type</label>

																		<div class="col-sm-8">
																			<input class="col-xs-12 col-sm-10" type="text" required="" id="form-field-username" placeholder="like sole propriatorship" name="company_type" value="<?php echo $company_type ?>" >
																		</div>
																	</div>
																	<div class="form-group">
																		<label class="col-sm-4 control-label no-padding-right" for="form-field-username">Company Address</label>

																		<div class="col-sm-8">
																			<input class="col-xs-12 col-sm-10" type="text" required="" id="form-field-username" placeholder="address" name="address" value="<?php echo $address ?>" >
																		</div>
																	</div>
																	
																	<div class="form-group">
																		<label class="col-sm-4 control-label no-padding-right" for="form-field-username">Specialisation/ daily work</label>

																		<div class="col-sm-8">
																			<input class="col-xs-12 col-sm-10" type="text" required="" id="form-field-username" placeholder="Information Technology" name="specialisation" value="<?php echo $specialisation ?>" />
																		</div>
																	</div>
																	<div class="form-group">
																		<label class="col-sm-4 control-label no-padding-right" for="form-field-username">Type of vacancy</label>

																		<div class="col-sm-8">
																			<input class="col-xs-12 col-sm-10" type="text" id="form-field-username" placeholder="company vacancy available" name="vacancy" value="<?php echo $vacancy ?>" />
																		</div>
																	</div>
															...
															<div class="form-group">
																<label class=" control-label no-padding-right" for="form-field-comment"><font color="green"><u>Description about your company, like company background or capacity, way of employment, contracts, etc:</u></font></label>
													  ...
													  <textarea class="form-control" required="" name="information" id="exampleFormControlTextarea3"  placeholder="Write something like company background or capacity, way of employment, contracts, etc"  rows="7">
